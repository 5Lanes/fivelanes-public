...
function minuteTo12hVariants(minute) {
...
function rangeSearchVariants(startMinute, endMinute) {
...
export function formatCounterpartySlotLabel(slot) {
    const startMinute = parseHmToMinutes(slot.start);
    const endMinute = parseHmToMinutes(slot.end);
